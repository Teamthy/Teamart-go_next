    ...
    <div className="space-y-8 pb-12">
      <section className="rounded-[32px] bg-[linear-gradient(135deg,#fff8fb_0%,#ffffff_55%,#ecfdf5_100%)] p-5 sm:p-6">
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr] xl:items-center">
          <div className="space-y-5">
            <Badge tone="default">
              TikTok + Amazon + Seller Central layer
            </Badge>

            <div className="space-y-3">
              <p className="text-[11px] uppercase tracking-[0.24em] text-[#E91E63]">
                Teamart-go_next
              </p>

              <h1 className="text-[30px] font-semibold tracking-tight text-zinc-900 sm:text-[34px]">
                Premium social commerce with scroll-first discovery and
                checkout-ready moments.
              </h1>

              <p className="max-w-2xl text-sm leading-7 text-zinc-600 sm:text-[15px]">
                Swipe through creator-led content, launch into live rooms,
                follow stores, and buy from a polished commerce surface
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div
                  key={stat.label}
                  className="rounded-[24px] bg-white px-4 py-4 shadow-[0_18px_45px_rgba(15,23,42,0.08)]"
                >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Card className="p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-600">
                Fresh social content surfaced in one clean scrollable experience.
              </p>
            </Card>
            ...
            <Card className="p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-600">
                Promos, inventory, and product performance ready for professional
                merchandising.
              </p>
            </Card>
          </div>
      ...
      <section className="space-y-3">
        <SectionHeader
          ...
          description="Jump into the most active shopping spaces."
        />
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_0.9fr]">
        <div className="space-y-4">
          <SectionHeader
            ...
            description="A curated slice of creator drops."
          />
            ...
            <div className="mt-3 space-y-3">
              {stores.slice(0, 4).map((store) => (
                <Link
                  ...
                  className="block rounded-[24px] bg-[#FFF8FB] p-3"
                >
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              {creators.map((creator) => (
                <Link
                  ...
                  className="rounded-[24px] bg-zinc-50 p-3"
                >
                  <p className="text-sm font-semibold text-zinc-900">
                    {creator.name}
                  </p>
      ...
      <section className="space-y-4">
        <SectionHeader
          ...
          description="Creator favorites and social-ready commerce picks."
        />
      ...
      <section className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="p-5">
          ...
          <h2 className="mt-3 text-[22px] font-semibold text-zinc-900">
            Keep every drop conversion-ready
          </h2>
