                        ...
                        {item.subItems ? (
                            <>
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isActive(item.href)
                                ...
                                >
                                    ...
                                    <span
                                        className={`transition-transform ${(expandedItems.includes(item.href) || item.href === activeParent) ? "rotate-180" : ""
                                            }`}
                                    >
                                        ▼
                                    </span>
                                </button>
                                {(expandedItems.includes(item.href) || item.href === activeParent) && (
